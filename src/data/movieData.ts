...
export const topMovies: Movie[] = [
  ...
  { rank: 5, title: "Ne Zha: Mo tong nao hai", boxOffice: "$2.08B", year: 2025, country: "China", posterUrl: "/bigposts/homepage_post.webp" },
  { rank: 6, title: "Star Wars: The Force Awakens", boxOffice: "$2.07B", year: 2015, country: "USA" },
  { rank: 7, title: "Avengers: Infinity War", boxOffice: "$2.05B", year: 2018, country: "USA" },
  { rank: 8, title: "Spider-Man: No Way Home", boxOffice: "$1.92B", year: 2021, country: "USA" },
  ...
  { rank: 12, title: "The Avengers", boxOffice: "$1.52B", year: 2012, country: "USA" },
  { rank: 13, title: "Furious 7", boxOffice: "$1.52B", year: 2015, country: "USA" },
  { rank: 14, title: "Top Gun: Maverick", boxOffice: "$1.50B", year: 2022, country: "USA" },
  { rank: 15, title: "Frozen II", boxOffice: "$1.45B", year: 2019, country: "USA" },
  { rank: 16, title: "Barbie", boxOffice: "$1.45B", year: 2023, country: "USA" },
  { rank: 17, title: "Avengers: Age of Ultron", boxOffice: "$1.40B", year: 2015, country: "USA" },
...
// 获取票房第一的电影数据
export const getTopMovie = () => topMovies.find(movie => movie.title === "Ne Zha: Mo tong nao hai");
